        ...
        <div class="row">
            <div class="col-sm-6">
                <div dnd-droppable class="panel panel-info" [allowDrop]="allowDropFunction(box1Integer)" (onDropSuccess)="addTobox1Items($event)">
                    <div class="panel-heading">
                        Multiples of
                        <nz-input-number [(ngModel)]="box1Integer" [nzMin]="1" [nzMax]="10" [nzStep]="1"></nz-input-number>                                                
                        only
                    </div>
                    <div class="panel-body">
            ...
            <div class="col-sm-6">
                <div dnd-droppable class="panel panel-warning" [allowDrop]="allowDropFunction(box2Integer)" (onDropSuccess)="addTobox2Items($event)">
                    <div class="panel-heading">
                        Multiples of
                        <nz-input-number [(ngModel)]="box2Integer" [nzMin]="1" [nzMax]="10" [nzStep]="1"></nz-input-number>                        
                        only
                    </div>
                    <div class="panel-body">
